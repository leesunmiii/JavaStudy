	...
	public static void main(String[] args) {
		...
		try
		{
			...
			for(int i=0;i<link.size();i++)
			{
				...
				Element state=doc2.selectFirst("h3.tit_movie span.txt_tag");
...
//				System.out.println(image);
				...
				String msg=(i+1)+"|"+title.text()+"|"+state.text()+"|"+image+"|"
						+dd1.text()+"|"
						+dd2.text()+"|"
						+dd3.text()+"|"
						+dd4.text()+"|"
						+dd5.text()+"|"+"\r\n";
//				msg=msg.substring(0,msg.lastIndexOf("|"));//마지막에 \ 하나 붙어서 제거 하려는거
//				msg+="\r\n"; //마지막에 \ 하나 붙어서 제거 하려는거
