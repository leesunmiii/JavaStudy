...
import com.sist.lib.MainClass_01;
import java.io.*;
import java.util.*;
// Music을 제어하는 프로그램

public class MusicManager {
	private Music[] musics=new Music[48];
	...
	/*
	 문제 1. 예외에 대한 설명 중 틀린 것은 무엇입니까?
		...
		예외처리 종류 (예외 : java.io, java.net, java.sql)
					...
					= 예외 회피 (예외 떠맡기기)
						=> 라이브러리에서 많이 사용 => 개발자
						=> 예상되는 에러를 선언 => 컴파일러가 확인을 안하고 동작할 수 있게
							method() throws 예외처리종류...(순서 상관없다)
						=> 처리 방법은 throws 이용, try~catch 이용
					= 임의의 발생
						=> throw new 예외처리생성자()
					= 사용자 정의 예외처리
		...
		문제 2. try-catch-finally 블록에 대한 설명 중 틀린 것은 무엇입니까?
			
			① try { } 블록에는 예외가 발생할 수 있는 코드를 작성한다.
							---------------------- 사용자 입력에 따라 달라진다 => 오류가 있을수도 있고 없을수도 있고
		...
		문제 3. throws에 대한 설명으로 틀린 것은 무엇입니까?
			...
			④ 새로운 예외를 발생시키기 위해 사용된다. ==============================> 답
			---------------------------------
			 => throw
			 
		문제 4. throw에 대한 설명으로 틀린 것은 무엇입니까?

			① 예외를 최초로 발생시키는 코드이다.
			② 예외를 호출한 곳으로 떠넘기기 위해 메소드 선언부에 작성된다. ==================================> 답
			------------------------------------------------
				=> throws
