...
/*
 		= 중복 데이터 ==> ArrayList
 		= 중복이 없는 데이터 => HashSet
 		= 두 개를 저장해서 찾는다 => HashMap : 클래스 찾기, SQL 찾기
 								------- Annotation
 		--------------------------------
 	 	...
 	 	= 사용처
 	 	  ...
 	 	  => 데이터 전송
 	 	  	 ...
 	 	  	 => session / cookie
 	 	  	 			  ------ 최신 방문
 	 	  => 라이브러리
 	 	  	 Spring ==> HashMap => key, 클래스 객체 => 클래스 관리 => 클래스 찾기(DL)
 	 	  	 													---------- getBean("key")
 	 	  	 			객체의 생명주기 => 생성 ~ 소멸
 	 	  	 			=> WEB (라이브러리의 일부)
...
public class MainClass_08 {
	...
	public static void main(String[] args) {
		...
		//Map map=new HashMap(); // 이렇게 하면 Object가 돼서 매번 형변환을 해줘야함
...
//		System.out.println("PHONE:"+map.get("phone"));
		...
		Set<String> set=map.keySet(); // set안에 key를 다 모을 수 있음
