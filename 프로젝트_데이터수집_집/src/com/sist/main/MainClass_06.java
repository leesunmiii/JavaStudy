        ...
        try
        {
        	...
        	for(int i=0;i<=96;i++)
        	{
        	   ...
        	   try
        	   {
        		 ...
        		 System.out.println("상세 포스터 :"+sub_poster.get(0).attr("src"));
        		 System.out.println("상세 타이틀 :"+sub_title.get(0).text());
        		 System.out.println("서브 타이틀 :"+sub_title2.get(0).text());
        		 System.out.println("상세 설명 :"+sub_explain.get(0).text());
        		 System.out.println("상세 가격 :"+sub_money.get(0).text());
