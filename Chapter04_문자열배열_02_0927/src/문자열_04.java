...
String[] title={
		...
		//System.out.println("가장 많이 상승한 노래의 제목과 가수 : "+max);
		for(int i=0;i<title.length;i++)
		{
		...
		System.out.println("======================================================================");
		// 노래명중에 가장 긴 제목의 노래와 가수명, 앨범명 출력하시오
		max=0;
//		for(int i=0;i<title.length;i++)
...
//				max=title[i];
		...
		System.out.println("순위 하강한 곡:"+count+"곡");
		System.out.println("======================================================================");
		//임영웅의 노래 제목을 출력하시오
		count=0;
		for(i=0;i<title.length;i++)
		...
		System.out.println("======================================================================");
		// 검색어 입력 받아서 검색어가 포함되어 있는 노래명 출력
