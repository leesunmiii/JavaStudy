...
public class 메소드_05_변경 {
	...
	static void scoreCheck(int[] score, double[] avg)
	{
	...
	static void rankCheck(int[] total, int[] rank)
	{
		for(int i=0;i<3;i++)
		{
			rank[i]=1;
	...
	static void print(int[] kor,int[] eng,int[] math,int[] total,double[] avg, int[] score, int[] rank)
	{
		for(int i=0;i<3;i++)
		{
